...
<div class="wrapper">
  <br>
     <h1 style="text-align:center">Adds the Hostel Rules and Regulations</h1><br>
    ...
    <div class="container">
      ...
      <form id="contact" action="" method="post" enctype="multipart/form-data"> 
        <div class="row">
          ...
          <div class="col-75">
           <textarea name="hostel_rule" placeholder="provide the rules and regulations here"  style="height:100vh;width: 700px;" required ></textarea>
          </div>
        </div>
        <br>
        <br>
      ...
      if(isset($_POST['up']))
      {
          $hostel_rule=$_POST['hostel_rule'];       
         if ($_SERVER["REQUEST_METHOD"] == "POST") 
         {
            $sql="INSERT into hostel_rules(rule_id,hostel_rule_regulation,hostel_id) 
            values(NULL,'$hostel_rule',$hostel_id);";
            $result=mysqli_query($con,$sql);
            if($result)
            { 
                echo '<script>alert("Hostel rules and regulations  Added Successfull");window.location.href = "tes.php";</script>';

            }
            else
            {
                 echo '<script>alert("Hostel  Failed to add  Hostel rules and regulations ");</script>';
            }
        }

    ...
    <div class="banner">
        <div class="navbar">
         ...
         <div class="content">
            ...
            <div class="pop-container">
                <h1>Hostel Owner Login Page</h1>
                <p><label style="float: left;">Email or Phone</label>
                 <input type="email" name="user" placeholder="enter your email..." required><br>
                </p>
                <p><label style="float:left;">Password</label>
                ...
                <div class="link">New user<a href="owner_register.php" style="text-decoration:none;color: white; background: transparent;">&nbsp;Sign up here</a></div><br></p>
                <br>
            </div>
        </form>
        </div>
        ...
        include"connection.php";
            if(isset($_POST['sub']))
            {
                $user = $_POST['user'];
                 $pass = $_POST['pass'];
                 $sql="SELECT * from hostel_owner where email='$user' and password='$pass'";
                 ...
                 if(is_array($row))
                 {
                    if($user==$row['email'] && $pass==$row['password'])
                    {
                        ...
                        // $_SESSION['hostel']e
                          echo '<script> window.location.href="tes.php";</script>';            //  On Successful Login redirects to home.php

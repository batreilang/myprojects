...
<body>
   ...
   <?php
            $sa="SELECT * from payment where student_id=$student_id and hostel_id=$hostel_id;";
            $s=($con->query($sa));
            if($s)
            {
...
<div class="wrapper">
  <br>
    ...
    <div class="container">
      ...
      <br>
      <div class="row">
        <label>We received Your Payment for the Hostel Addmission Fees, here is your reference no.</label>
        <div class="col-25">

...
<div class="wrapper">
  <br>
     <h1 style="text-align:center">Adds the Hostel Facilities</h1><br>
      ...
      <form id="contact" action="" method="post" enctype="multipart/form-data"> 
        <div class="row">
          ...
          <div class="col-75">
            ...
            <input  type="text" placeholder="details on Electricity" required autofocus="" name="electricity">
          </div>
        </div>
        <br>
        <br>
        <div class="row">
          ...
          <div class="col-75">
            <input type="text" name="water" placeholder="water distribute on hostel">
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input type="text" name="computer" placeholder="computer in hostel">
          </div>
        </div>
        <br>
         <div class="row">
          ...
          <div class="col-75">
            <input type="text" name="internet" placeholder="internet aroun campuss">
          </div>
        </div>
        <br>
         <div class="row">
          ...
          <div class="col-75">
            <input type="text" name="safety" placeholder="safety around campuss">
       ...
       if(isset($_POST['up']))
        {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") 
            {
                    ...
                    $insert = $con->query("INSERT into hostel_facilities(facility_id,electricity,water,internet,safety,hostel_id)  
                        VALUES (NULL,'$e','$w','$i','$s',$hostel_id)");
                    if($insert)
                    {
                       echo '<script>alert("Hostel Facilities Added Successfull");window.location.href = "hostel_rule.php";</script>';
                    }
                    else
                    {

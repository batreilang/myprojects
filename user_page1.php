    ...
    <ul>
      ...
      if($r)
      {
        ...
        if($check>0)
        {
          ...
          ?>
           <li style="font-size:25px"><a href="status_application.php">Status</a></li>
          <?php
...
<div class="wrapper" style="padding-top: 10%;">
    <div style="" class="ser">
      <a href="" class="bar" style="color:white"><i class="fas fa-bars"></i></a>
       <form method="POST" action="search_city.php" class="example" style="text-align: center;">
      <input type="text" placeholder="Search by city name eg tura or shillong.." name="city" class="search">
    ...
    <div class="container">
         <!-- query to retrieve the hostel details from hostel_info and hostel_owner tables-->               
               <?php
      include"connection.php";
            //$sql="SELECT  i.*, im.*  from hostel_info i, hostel_images im where i.hostel_id=im.hostel_id;";
        ...
        <div class="row">
          ...
          <div class="col-25">
            <div class="row" style="width:100%">
                  ...
                  <br>
                  <b style="font-size:25px"><em>Hostel Name:&emsp;&emsp;<?php echo $hostelname;?></em><br></b>
                 <em>Hostel Type:&emsp;&emsp;&nbsp;&nbsp;<?php echo $hosteltype;?></em><br>
                 <br><br>
                  <u><em> Updated on:<?php  echo $date?>
                  </em></u><br>
                 ...
                 <?php
                  ...
                  else
                  {
                    ...
                    <em>No more Available Room:&emsp;&nbsp;</em><br>
                    <?php
            ...
            <br><br><br>
             <a href="view_detail.php?hostelid=<?php echo $hid?>" class="back">Book Room</a>
          </div>
         </a>
         <div class="col-75">
          <div class="row">
